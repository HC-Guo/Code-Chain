...
prompt= "Write a configuration file for the project based on the following file contents and their dependency relationships.  "
        ...
        for future in concurrent.futures.as_completed(futures):
            try:  
                ...
                if result is not None:
                    count+=1
                    with open('../Codechain/dataset/instructions/instruction_task5.json', 'r') as file:
                ...
                with open("../Codechain/utils/instruction/error_task5.txt", 'a') as error_file:
